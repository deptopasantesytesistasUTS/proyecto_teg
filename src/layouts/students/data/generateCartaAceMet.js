    ...
    <Document>
      <Page size="Letter" style={styles.page}>
        ...
        <View style={styles.title}>
          <Text>APROBACIÓN DEL TUTOR METODOLÓGICO</Text>
        </View>

        {/* Main content */}
        <View style={styles.paragraph}>
          <Text>En mi carácter de tutor metodológico del Trabajo Especial de Grado titulado:</Text>
        </View>
        ...
        <View style={styles.paragraph}>
          <Text>
            ...
            <Text style={styles.bold}>T.S.U. en {data.carrera}</Text>. Este trabajo ha sido aprobado
            con correcciones previa autorización del Consejo Académico Directivo realizado el{" "}
            {data.fecha}, y podrá ser sometido a presentación pública y evaluación por parte del
            Jurado Examinador que se designe, quedando comprometido a realizar y cumplir con todas
            las correcciones metodológicas indicadas.
          </Text>
        </View>
...
const CartaAprMetGenerator = ({data}) => {
...
CartaAprMetGenerator.propTypes = {
  data: PropTypes.shape({
    nombre: PropTypes.string,
    cedula: PropTypes.string,
    carrera: PropTypes.string,
...
export default CartaAprMetGenerator;
